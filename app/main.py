...
from app.body_page import router as body_router
...
def root():
    return {
        ...
        "next_steps": [
            ...
            "3. GET /dashboard for a visual summary, /body for the organ + ICD-10 health map, or /recovery, /sleep, /workouts, /cycles, /profile for raw data",
        ],
    }
